...
const TranslatorPage = () => {
  ...
  // Animate typing effect for translated text
  useEffect(() => {
    if (!translatedText) {
      setDisplayedText("");
      return;
  ...
  // Play translated text audio (TTS)
  const playAudio = () => {
  ...
  // Voice waveform visualization effect
  useEffect(() => {
    if (!recording) {
